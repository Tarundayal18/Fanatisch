...
export default function ContactCTA({ scrollY }: { scrollY: number }) {
  ...
  return (
    <section className="bg-[#f2cb05] relative">
      {/* Top Curve Shape */}
      <div
  ...
  >
    ...
    >
      ...
      {/* Modal Title */}
      <h2 className="text-2xl md:text-3xl font-bold text-[#6c0505] mb-6 text-center">
        Get in Touch
      </h2>
      ...
      >
        <div className="relative overflow-visible rounded-[3rem] bg-[#4744a6] px-8 py-16 text-center md:px-16 border border-[#1f2a3c] shadow-2xl">
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-lg font-lufga font-semibold text-[#6c0505] transition-all hover:bg-gray-100 hover:scale-105"
          >
            Get In Touch
            <svg
