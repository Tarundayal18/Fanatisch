...
export default function CoreBenefits() {
  ...
  return (
    ...
    >
        ...
        @keyframes gradientGlow {
          ...
          100% {
            box-shadow: 0 0 30px rgba(59, 130, 246, 0.8), 0 0 60px rgba(59, 130, 246, 0.6),
              0 0 90px rgba(59, 130, 246, 0.4), 0 0 120px rgba(59, 130, 246, 0.2);
          }
          25% {
            box-shadow: 0 0 30px rgba(147, 51, 234, 0.8), 0 0 60px rgba(147, 51, 234, 0.6),
              0 0 90px rgba(147, 51, 234, 0.4), 0 0 120px rgba(147, 51, 234, 0.2);
          }
          50% {
            box-shadow: 0 0 30px rgba(239, 68, 68, 0.8), 0 0 60px rgba(239, 68, 68, 0.6),
              0 0 90px rgba(239, 68, 68, 0.4), 0 0 120px rgba(239, 68, 68, 0.2);
          }
          75% {
            box-shadow: 0 0 30px rgba(147, 51, 234, 0.8), 0 0 60px rgba(147, 51, 234, 0.6),
              0 0 90px rgba(147, 51, 234, 0.4), 0 0 120px rgba(147, 51, 234, 0.2);
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12 lg:mb-20 space-y-6">
          <div className="inline-block px-6 py-2 rounded-full bg-white/40 backdrop-blur-md border border-white/60 text-sm sm:text-base font-semibold tracking-widest text-[#6c0505] uppercase shadow-lg">
            Core Benefits
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#6c0505] leading-tight">
            The Value Behind the{" "}
            <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-red-600 bg-clip-text text-transparent">
              Platform
            </span>
          </h2>
          <p className="text-base sm:text-lg text-[#070756] max-w-2xl mx-auto leading-relaxed">
            Easily track and manage your sales pipeline with real-time updates and visual deal stages.
          </p>
        </div>
                ...
                >
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <h3 className="text-2xl font-bold text-[#6c0505] leading-tight">
                        {benefit.title}
                      </h3>
                      ...
                      <div className="pt-4 border-t border-blue-600/20">
                        {benefit.comingSoon ? (
                          ...
                          <span className="text-sm text-blue-600 font-semibold">Learn More →</span>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <h3 className="text-2xl font-bold text-[#6c0505] leading-tight">{benefit.title}</h3>
                ...
                >
                  ...
                  >
                    <div className="space-y-4 flex flex-col h-full">
                      ...
                      <h3 className="text-xl font-bold text-[#6c0505] group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-red-600 group-hover:text-transparent group-hover:bg-clip-text transition-all duration-300 leading-tight">
                        {benefit.title}
                      </h3>

                      <p className="text-sm text-[#070756] leading-relaxed">{benefit.description}</p>

                      <div className="pt-3 border-t border-blue-600/20 group-hover:border-red-500/50 transition-colors duration-300">
                        {benefit.comingSoon ? (
                          <span className="text-xs text-gray-500 font-semibold">Coming Soon</span>
                        ) : (
                          <span className="text-xs text-blue-600 font-semibold group-hover:translate-x-1 inline-block transition-transform duration-300">
                            Learn More →
                          </span>
                        )}
                      </div>
