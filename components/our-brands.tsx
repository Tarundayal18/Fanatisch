...
//               >
//                 <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-white flex items-center justify-center shadow-2xl border-4 border-blue-600/20 glow-animation">
...
//               <div className="relative w-32 h-32 rounded-full bg-white flex items-center justify-center shadow-2xl border-4 border-blue-600/20 glow-animation">
